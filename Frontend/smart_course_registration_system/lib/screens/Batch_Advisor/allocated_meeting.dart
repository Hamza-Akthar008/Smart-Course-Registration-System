...
class AllocateMeetingBatchAdvisor extends StatefulWidget {
  @override
  _AllocateMeetingBatchAdvisor createState() => _AllocateMeetingBatchAdvisor();
}

class _AllocateMeetingBatchAdvisor extends State<AllocateMeetingBatchAdvisor> {
