...
class RecommendApplication extends StatefulWidget {
  @override
  _RecommendApplication createState() => _RecommendApplication();
}
class _RecommendApplication extends State<RecommendApplication> {
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      DashboardScreenHOD(parameter: "Recommend Application"),
                      SizedBox(height: 20),
                      Container(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Batch Advisor Comments',
                      ...
                      if (isApplicationProcessed()) // If application is already processed
                        Padding(
                          ...
                          child: Text(
                            'Application already Recommened',
                            style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w900,
                            ),
  ...
  bool isApplicationProcessed() {
    ...
    return applications.isNotEmpty && (applications[0]['isRecommended'] );
  }
  ...
  void _approveApplication(bool approve, bool reject) async {
    ...
    final Map<String, dynamic> data = {
      ...
      'batchAdvisorComment': hodComment,
