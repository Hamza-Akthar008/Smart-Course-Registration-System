  ...
  void filterByStatus(String status) {
    setState(() {
      ...
      filteredData = widget.data.where((application) {
        if (status == 'none') {
          return (application['isRecommended']==true&&application['isApproved']==false && application['isRejected']==false);
        } else {
        ...
        Theme(
          ...
          child: PaginatedDataTable(
            columns: [
              ...
              DataColumn(label: Text('HOD Comments')),
...
class _ApplicationDataSource extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow(cells: [
      ...
      DataCell(Center(child: Text('${application['isApproved']}'))),
      DataCell(Center(child: Text('${application['isRejected']}'))),
      DataCell(Center(
          child: Text(
              '${(application['hodComments'].isEmpty) ? "NO Comment Available" : application['hodComments']}'))),
      DataCell(
        Center(
          child: IconButton(
